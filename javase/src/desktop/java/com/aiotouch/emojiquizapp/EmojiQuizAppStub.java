 ...
 * @author Shai Almog
 */
public class EmojiQuizAppStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "EmojiQuizApp";
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new EmojiQuizAppStub());
    }
